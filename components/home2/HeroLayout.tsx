      ...
      <header className="relative w-full max-w-7xl mx-auto px-6 py-2 md:py-3 flex items-center justify-between z-30">
        ...
        <nav className="hidden md:flex items-center gap-10">
          <Link href="/lands" className="text-white font-semibold text-sm hover:text-white/80 transition relative pb-1.5 group">
            Lands
            <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-1.5 h-1.5 bg-[#8b5cf6] rounded-full shadow-[0_0_8px_rgba(139,92,246,0.8)]" />
          </Link>
      ...
      <main className="relative w-full max-w-7xl mx-auto px-6 z-20 flex-grow flex flex-col lg:flex-row items-start lg:items-end justify-between pb-12 lg:pb-24 gap-12 mt-16 lg:mt-0">
        ...
        <div className="flex flex-col items-start max-w-2xl">
          <h1 className="text-[60px] sm:text-[80px] md:text-[100px] font-sans font-black tracking-tight leading-[0.95] text-white">
            <span className="block bg-gradient-to-b from-white to-stone-200 bg-clip-text text-transparent">Land.</span>
            <span className="block bg-gradient-to-b from-white to-stone-200 bg-clip-text text-transparent">Clarity.</span>
            <span className="block text-[#8b5cf6] relative mt-1">
              Haryana.
              <span className="absolute -bottom-3 left-0 w-24 h-[5px] bg-[#8b5cf6] rounded-full shadow-[0_0_12px_rgba(139,92,246,0.6)]" />
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 mt-8 w-full sm:w-auto">
            ...
            <Link 
              href="/lands"
              className="w-full sm:w-auto bg-gradient-to-r from-[#6d28d9] to-[#8b5cf6] hover:from-[#5b21b6] hover:to-[#7c3aed] text-white font-bold pl-7 pr-3 py-2.5 rounded-full transition-all flex items-center justify-between gap-4 shadow-lg shadow-purple-900/30 active:scale-[0.98] cursor-pointer"
            >
              <span className="text-[13px] tracking-wider uppercase">Explore Lands</span>
              <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center text-[#7c3aed] shrink-0">
          ...
          <div className="w-full md:w-[400px] lg:w-[420px] bg-white/5 backdrop-blur-md border border-white/10 rounded-[28px] p-6 shadow-2xl shadow-black/40 flex items-center justify-between gap-4 transition-all duration-300 hover:bg-white/[0.07] hover:border-white/15">
            <div className="flex items-center gap-5">
              ...
              <div className="relative w-16 h-16 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center shrink-0 shadow-inner">
                {/* Glow ring */}
                <div className="absolute inset-0 bg-[#8b5cf6]/10 blur-md rounded-full pointer-events-none scale-75" />
                <MapPin className="text-[#a78bfa] relative z-10" size={26} strokeWidth={2.5} />
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <span className="text-[#a78bfa] font-black text-sm tracking-wide mt-1">₹ 38,00,000</span>
              </div>
            </div>
